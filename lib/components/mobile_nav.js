    ...
    value: function _renderLinks() {
      ...
      if (checker.checkArray(links)) {
        return _.map(links, function (ni) {
          return React.createElement(Navitem, { key: ni.id, ref: ni.id, item: ni, onClick: _this2._nextLevel.bind(_this2), device: _this2.props.device });
        });
      }
...
//# sourceMappingURL=mobile_nav.js.map